...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('logs/bot_with_api.log', encoding='utf-8')
    ]
)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if current_state == "main":
        ...
        # Тестовый ответ для RAG режима
        response = f"🔍 **Режим RAG**\n\nВаш вопрос: '{query_text}'\n\nЭто тестовый ответ. В реальной версии здесь будет RAG система с локальной базой знаний."
...
def main():
    ...
    # Запуск бота
    logger.info("Starting bot with DeepSeek API integration...")
