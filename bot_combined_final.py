...
import requests
from rag_keywords_extended import extended_rag_responses
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('logs/bot_combined_final.log', encoding='utf-8')
    ]
)
...
def process_rag_query(question: str) -> str:
    ...
    try:
        ...
        # Упрощенная RAG логика - расширенная база ключевых слов
        rag_responses = {
            # Товары и продукция
            ...
            "продукты": "🏢 **Наши товары и услуги:**\n\n• Ноутбуки BusinessPro и GamerForce\n• Настольные компьютеры\n• Серверы и рабочие станции\n• Мониторы и периферия\n• Программное обеспечение\n• Консультационные услуги\n\nДля получения подробной информации обратитесь к менеджеру.",
            "продукция": "🏢 **Наши товары и услуги:**\n\n• Ноутбуки BusinessPro и GamerForce\n• Настольные компьютеры\n• Серверы и рабочие станции\n• Мониторы и периферия\n• Программное обеспечение\n• Консультационные услуги\n\nДля получения подробной информации обратитесь к менеджеру.",
            "что продаете": "🏢 **Наши товары и услуги:**\n\n• Ноутбуки BusinessPro и GamerForce\n• Настольные компьютеры\n• Серверы и рабочие станции\n• Мониторы и периферия\n• Программное обеспечение\n• Консультационные услуги\n\nДля получения подробной информации обратитесь к менеджеру.",
            "ассортимент": "🏢 **Наши товары и услуги:**\n\n• Ноутбуки BusinessPro и GamerForce\n• Настольные компьютеры\n• Серверы и рабочие станции\n• Мониторы и периферия\n• Программное обеспечение\n• Консультационные услуги\n\nДля получения подробной информации обратитесь к менеджеру.",
            ...
            "компании": "🏢 **О компании ТехноПлюс:**\n\n• **Год основания:** 2010\n• **Миссия:** Предоставлять качественную компьютерную технику и профессиональную поддержку\n• **Ценности:** Качество, Надежность, Клиентоориентированность, Инновации\n\n📍 **Продукты:** Ноутбуки, Компьютеры, Серверы, Мониторы\n🎯 **Услуги:** Техподдержка, Гарантийное обслуживание, Консультации",
            "расскажи о компании": "🏢 **О компании ТехноПлюс:**\n\n• **Год основания:** 2010\n• **Миссия:** Предоставлять качественную компьютерную технику и профессиональную поддержку\n• **Ценности:** Качество, Надежность, Клиентоориентированность, Инновации\n\n📍 **Продукты:** Ноутбуки, Компьютеры, Серверы, Мониторы\n🎯 **Услуги:** Техподдержка, Гарантийное обслуживание, Консультации",
            ...
            "услуги": "🛠️ **Наши услуги:**\n\n• Поставка оборудования\n• Техническое обслуживание\n• Консультации по выбору\n• Установка и настройка\n• Обучение сотрудников\n• Гарантийный ремонт\n\nПолный спектр IT-услуг для вашего бизнеса!"
        }
        
        question_lower = question.lower()
        
        # Объединяем базовые и расширенные ответы
        all_responses = {**rag_responses, **extended_rag_responses}
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        "👋 **Добро пожаловать!**\n\n"
        "Я умный бот-помощник с двумя режимами работы:\n\n"
        "🏢 **О компании** - информация о наших товарах, услугах и условиях\n"
        "❓ **Общие вопросы** - ответы на любые вопросы через ИИ\n\n"
        "Нажмите кнопку 'Старт' чтобы выбрать режим!"
    )
    ...
    try:
        if callback_data == "start":
            ...
            text = (
                ...
                "🏢 **О компании** - вопросы о наших товарах, услугах, ценах, доставке и условиях работы\n\n"
                "❓ **Общие вопросы** - любые другие вопросы, общение с ИИ-помощником\n\n"
            ...
            text = (
                "🏢 **Режим 'О компании' активирован**\n\n"
                "Теперь вы можете задавать вопросы о:\n"
                "• Товарах и услугах\n"
                "• Ценах и условиях\n"
                "• Доставке и оплате\n"
                "• Гарантии и сервисе\n"
                "• Контактах компании\n\n"
                "💡 Я отвечу на основе нашей базы знаний. Задавайте любые вопросы!"
            )
            ...
            text = (
                "❓ **Режим 'Общие вопросы' активирован**\n\n"
                "Теперь вы можете задавать любые вопросы:\n"
                "• Общие знания и факты\n"
                "• Помощь с задачами\n"
                "• Объяснения и советы\n"
                "• Творческие запросы\n\n"
                "🤖 Я отвечу с помощью DeepSeek AI. Задавайте любые вопросы!"
            )
            await query.edit_message_text(text, reply_markup=get_back_keyboard())
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if current_state == "main":
        ...
        # Отправляем сообщение о том, что обрабатываем запрос
        processing_msg = await update.message.reply_text("⏳ Обрабатываю ваш запрос с помощью ИИ...")
...
def main():
    ...
    logger.info("🚀 Starting combined final bot with RAG and DeepSeek API integration...")
    ...
    # Запуск бота
    logger.info("✅ Combined bot is ready! RAG + DeepSeek API modes available.")
