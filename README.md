...
- Быстрые ответы на основе расширенной базы ключевых слов
- Информация о товарах (ноутбуки, компьютеры, серверы)
- Подробные цены и условия оплаты (включая рассрочку)
- Условия доставки и гарантийное обслуживание
- Контакты и режим работы
- Скидки и акции
- Наличие товаров на складе
- Мгновенная обработка запросов (< 1 сек)
...
Создайте файл `.env`:
```env
# Обязательные для финального бота
TELEGRAM_TOKEN=your_telegram_token_here
DEEPSEEK_API_KEY=your_deepseek_api_key_here

# Только для LangChain RAG бота (не нужно для финального)
...
├── rag_keywords_extended.py  # 📝 Расширенная база ключевых слов (40+ вариантов)
...
6. **RAG режим не находит ответы**
   ...
   - Используйте ключевые слова: 
     - **Товары**: товары, продукты, ноутбуки, компьютеры, пк, лаптоп, ассортимент
     - **Цены**: цены, цена, стоимость, сколько стоит, прайс
     - **Доставка**: доставка, доставить, привезти, курьер
     - **Контакты**: контакты, телефон, адрес, где находитесь, как связаться
     - **Компания**: о компании, компании, расскажи о компании, кто вы
     - **Гарантии**: гарантия, гарантии, ремонт, гарантийное обслуживание
     - **Скидки**: скидки, скидка, акции, акция
     - **Наличие**: наличие, есть ли в наличии, остатки, склад
...
**📊 Статистика тестирования (обновлено):**
- **RAG запросы:** 5/5 успешных (100%)
- **DeepSeek API:** 1/1 успешных (100%)  
- **Навигация:** Все кнопки работают
- **Ошибки:** 0
- **Расширенные ключевые слова:** 40+ вариантов запросов

**⚡ Производительность:**
- **RAG ответы:** Мгновенно (< 1 сек)
- **DeepSeek API:** ~13 секунд (555 символов)
- **Память:** ~54 MB (легкий режим)
- **Стабильность:** Без сбоев

**🎯 Протестированные функции:**
- ✅ Кнопка "🚀 Старт"
- ✅ Режим "🏢 О компании": 
  - "коротко расскажи о компании" ✅
  - "какие товары есть?" ✅
  - "гарантии?" ✅
  - "доставка?" ✅
  - "цены?" ✅
